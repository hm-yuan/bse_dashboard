...
placeholder_chart_base <- function(type = "line", height = 330) {
  highcharter::highchart() |>
    highcharter::hc_chart(type = type, height = height, backgroundColor = "transparent", style = list(fontFamily = "-apple-system, BlinkMacSystemFont, 'Segoe UI', 'Microsoft YaHei', sans-serif")) |>
...
placeholder_market_bubble <- function() {
  ...
  placeholder_chart_base("bubble", 360) |>
...
placeholder_industry_treemap <- function() {
  ...
  placeholder_chart_base("treemap", 360) |>
...
placeholder_company_heatmap <- function() {
  ...
  placeholder_chart_base("heatmap", 360) |>
...
placeholder_company_quadrant <- function() {
  ...
  placeholder_with_seed(placeholder_seed("company_quadrant", 3L), {
    ...
    chart <- placeholder_chart_base("bubble", 360) |>
...
placeholder_listing_financing <- function() {
  ...
  placeholder_chart_base("column", 350) |>
